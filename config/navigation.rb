...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    #primary.item :contests, 'Contests', contests_path("championship", "all"), :highlights_on => lambda { current_context?({'contests' => ['index']}, {'contests' => ['new', 'create']}) }
      ...
      if selected and selected.contest.id == current_tournament.id
        primary.item :contest_instance, selected.name, contest_instance_menu_link(selected),
            :highlights_on => lambda { matches_current_context([HighlightCondition.new("contests", "join"), HighlightCondition.new("score_tables"), HighlightCondition.new("participants"), HighlightCondition.new("contests", "show"), HighlightCondition.new("contests", "upcoming_events"), HighlightCondition.new("contests", "latest_results"), HighlightCondition.new("invitations", "index", "admin")], [HighlightCondition.new("contests", "edit"), HighlightCondition.new("contests", "update"), HighlightCondition.new("invitations", "new"), HighlightCondition.new("invitations", "copy")])}
    ...
    primary.item :high_score_list, 'High Score', high_score_path(current_tournament.permalink), :highlights_on => lambda { current_controller_new 'high_scores' }    
